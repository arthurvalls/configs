...
local colors = {
  ...
  selection = '#1f2019',       -- Selection background (orange blended on bg)
  search = '#1e2414',          -- Search match background (gold blended on bg)
  visual = '#2d2711',          -- Visual mode selection (orange blended on bg)
...
hl('GitSignsAddLn', { bg = '#0f1e15' })
hl('GitSignsChangeLn', { bg = '#121a13' })
hl('GitSignsDeleteLn', { bg = '#111413' })

-- Diff
hl('DiffAdd', { fg = colors.none, bg = '#0f1e15' })
hl('DiffChange', { fg = colors.none, bg = '#121a13' })
hl('DiffDelete', { fg = colors.git_delete, bg = '#111413' })
hl('DiffText', { fg = colors.none, bg = '#1a2214' })
